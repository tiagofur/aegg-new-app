...
const ORDEN_TIPOS: ReporteMensual['tipo'][] = ['INGRESOS_MI_ADMIN', 'INGRESOS_AUXILIAR', 'INGRESOS']
...
export const ReportesTabSelector: React.FC<ReportesTabSelectorProps> = ({
    ...
    // Calcular progreso
    const reportesConDatos = reportes.filter((r) => r.datos && r.datos.length > 0).length
        ...
        <div className="bg-gray-50 rounded-lg px-3 py-2 border border-gray-200">
            <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-2">
                    <h3 className="text-sm font-semibold text-gray-700">📊 Reportes Mensuales:</h3>
                    <span
