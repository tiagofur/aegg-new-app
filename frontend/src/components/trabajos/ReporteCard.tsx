...
export const ReporteCard: React.FC<ReporteCardProps> = ({
    ...
    const localReporteVersion =
        localReporte.fechaImportacion ?? localReporte.fechaProcesado ?? localReporte.fechaCreacion
    ...
    useEffect(() => {
        if (verDatos && (reporte.tipo === 'INGRESOS_MI_ADMIN' || reporte.tipo === 'INGRESOS')) {
        ...
        <div className="border border-gray-200 rounded-lg bg-gray-50">
            <div className="p-4">
                ...
                {localReporte.archivoOriginal && (
                    <p className="text-xs text-gray-600 mb-3">📄 {localReporte.archivoOriginal}</p>
                )}

                {localReporte.fechaImportacion && (
                    <p className="text-xs text-gray-500 mb-3">
                        Importado: {new Date(localReporte.fechaImportacion).toLocaleString('es-ES')}
                    </p>
                )}
                ...
                <div className="flex gap-2">
                    <input
                        ...
                        disabled={isReadOnly || loading || localReporte.estado === 'PROCESADO'}
                    />
