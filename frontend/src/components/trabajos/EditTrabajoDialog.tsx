...
export const EditTrabajoDialog: React.FC<EditTrabajoDialogProps> = ({
    ...
    const [visibilidadEquipo, setVisibilidadEquipo] = useState<boolean>(trabajo.visibilidadEquipo)
    ...
    const [aprobadoPorId, setAprobadoPorId] = useState<string>(trabajo.aprobadoPorId || '')
    const [selectedClienteId, setSelectedClienteId] = useState<string>(trabajo.clienteId || '')
    const [selectedCliente, setSelectedCliente] = useState<Cliente | null>(trabajo.cliente ?? null)
