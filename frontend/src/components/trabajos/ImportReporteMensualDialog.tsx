...
export const ImportReporteMensualDialog: React.FC<ImportReporteMensualDialogProps> = ({
    isOpen,
    onClose,
    onSuccess,
    mesId,
    ...
    const handleImport = async () => {
        ...
        try {
            ...
            const errorMessage =
                err.response?.data?.message || err.message || 'Error al importar el reporte'
                ...
                <div className="p-6">
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                        ...
                        <ul className="text-sm text-blue-800 space-y-1 ml-7">
                            ...
                            <li>
                                • Archivo esperado:{' '}
                                <code className="bg-blue-100 px-1 rounded">{archivoEsperado}</code>
                            </li>
