...
export const MiAdminIngresosFooter: React.FC<MiAdminIngresosFooterProps> = ({
    ...
    const bgColorClass = getFooterBackgroundColor(totalesComparison?.isMatch ?? null)
        ...
        <div className={`${bgColorClass} px-4 py-4`}>
                ...
                {isComparisonActive && totalesComparison && (
                    <div className="flex items-center gap-4">
                        <div className="flex flex-col items-end">
                            <span className="text-xs text-gray-600 uppercase">Auxiliar Total</span>
                            <span className="text-sm font-semibold">
            ...
            {isComparisonActive && totalesComparison && (
                <div className="mt-2 pt-2 border-t border-gray-200">
                    <p className="text-xs text-gray-600 italic">{totalesComparison.tooltip}</p>
                </div>
            )}
        </div>
    )
