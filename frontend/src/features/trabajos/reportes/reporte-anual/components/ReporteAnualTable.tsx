 ...
 */
export const ReporteAnualTable: React.FC<ReporteAnualTableProps> = ({ trabajoId, anio }) => {
    ...
    if (error) {
        return (
            <div className="bg-red-50 border border-red-200 rounded p-4 m-4">
                <h3 className="text-red-800 font-semibold mb-2">Error al cargar reporte anual</h3>
    ...
    return (
        <div className="flex flex-col gap-4 p-2">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-2xl font-bold text-gray-900">Reporte Anual {anio}</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                        ...
                        <div className="text-xs text-green-600 mt-1">
                            {resumen.mesesPendientes > 0 && `${resumen.mesesPendientes} pendientes`}
                        </div>
                    </div>
                </div>
            )}
                    ...
                    <tbody>
                        {reportes.map((reporte: ReporteAnual) => (
                            ...
                            >
                                <td className="px-3 py-2">
                                    <div className="flex items-center gap-2">
                                        <span className="font-medium text-gray-900">
                                            {
                                                NOMBRES_MESES[
                                                    reporte.mes as keyof typeof NOMBRES_MESES
                                                ]
                                            }
                                        </span>
                                ...
                                <td className="px-3 py-2 text-center">{getEstadoBadge(reporte)}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm text-blue-800">
                        ...
                        <ul className="list-disc list-inside space-y-1">
                            <li>
                                <strong>Confirmado:</strong> La diferencia entre Mi Admin y Auxiliar
                                es menor a $0.10
                            </li>
                            <li>
                            ...
                            <li>
                                <strong>Pendiente:</strong> No se han guardado datos para este mes
                            </li>
                            <li>
                                Para guardar datos, ve a Mi Admin Ingresos del mes correspondiente y
                                usa el botón "Guardar en Base"
                            </li>
                        </ul>
                    </div>
                </div>
