...
import { AprobacionesDashboard, useAprobacionesDashboard } from '../features/trabajos/aprobaciones'

export const AprobacionesPage: React.FC = () => {
    const { user } = useAuth()
    const { data, loading, error, filters, updateFilters, refetch } = useAprobacionesDashboard()
