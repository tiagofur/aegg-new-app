...
import { Plus, Search, ShieldAlert, ShieldCheck, ShieldQuestion } from 'lucide-react'
import { useMutation, useQuery, useQueryClient } from '@tanstack/react-query'
import { AppShell } from '../components/layout/AppShell'
import { usersApi } from '../services/users'
import { AppUser, CreateUserPayload, DashboardRole, UpdateUserPayload } from '../types'
import { UserFormDialog, UserFormValues } from '../features/users/components/UserFormDialog'
import { ConfirmDeleteDialog } from '../features/users/components/ConfirmDeleteDialog'

const roleLabels: Record<DashboardRole, { label: string; Icon: typeof ShieldCheck }> = {
